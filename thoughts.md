...
There's better ways I could have done the settings for each implementation to allow for different input types, but special support for just range and button types is ok.